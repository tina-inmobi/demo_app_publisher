...
@interface LTSplashViewController ()<IMNativeDelegate>
...
@implementation LTSplashViewController
...
- (void)viewDidLoad {
    ...
    WEAKSELF;
    [self setNavTitle:@"splash" color:UIColor.blackColor];
